...
if __name__ == "__main__":
    ...
    model.train(
        data="data_wallet.yaml",
        epochs=100,          # com 113 imagens, 50–150 épocas costuma ajudar
        imgsz=640,
        batch=4,            # ajuste conforme sua GPU/CPU
        device="cpu",            # 0 para primeira GPU; use "cpu" se não tiver GPU
        workers=0,
    ...
    model.val(data="data_wallet.yaml", imgsz=640)
